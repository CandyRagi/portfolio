...
const projectsData: Project[] = [
  ...
  },
  {
    ...
    image: "gradient",
    link: "#",
    github: "https://github.com/CandyRagi/shell-clone.git",
    Readme: "https://github.com/CandyRagi/shell-clone/blob/main/README.md",
    animation: "flipPulse",
    bgGradient: "from-indigo-950 via-purple-900 to-black",
    accentColor: "from-indigo-400 via-purple-500 to-pink-600",
    ...
    subtitle: "High-Concurrency Chat Relay with Fuzzing Clients",
    description: "A multi-client group chat server written in C, built as a systems programming assignment. Features include non-blocking I/O using poll(), globally consistent message ordering, graceful two-phase commit shutdown protocol, and custom POSIX thread-based fuzzing clients.",
    tags: ["C", "CMake", "POSIX Sockets", "Multithreading"],
    image: "gradient",
    link: "#",
    github: "https://github.com/CandyRagi/group-chat-server",
    Readme: "https://github.com/CandyRagi/group-chat-server/blob/main/README.md",
    animation: "tiles",
